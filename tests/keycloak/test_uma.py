...
class KeycloakOpenidConnectTestCase(TestCase):
    ...
    def test_resource_set_read(self):
        result = self.uma_client.resource_set_read(token="test-token", id="test-id")
    ...
    def test_resource_set_delete(self):
        result = self.uma_client.resource_set_delete(token="test-token", id="test-id")
    ...
    def test_permission_delete(self):
        result = self.uma_client.permission_delete(token="test-token", id="test-id")
